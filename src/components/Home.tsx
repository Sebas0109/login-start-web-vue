...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-secondary relative">
      ...
      {/* Header */}
      <header className="relative z-10 bg-gradient-card backdrop-blur-lg border-b border-border/50">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Button 
                ...
                className="transition-smooth hover:bg-destructive/10 hover:border-destructive/50"
              >
